...
void usage()
{
    fprintf(
        ...
        "                                 traffic does not refresh key LRU/LFU access recency. Known\n"
        "                                 gap: under --retry-on-error, a request replayed right after a\n"
        "                                 reconnect can currently reach the server before NO-TOUCH is\n"
        "                                 re-armed on the new connection\n"
