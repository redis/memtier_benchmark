...
void usage()
{
    fprintf(
        ...
        "                                 traffic does not refresh key LRU/LFU access recency. Under\n"
        "                                 --retry-on-error a reconnect can briefly let traffic through\n"
        "                                 before this (and other connection-setup steps: AUTH/SELECT/\n"
        "                                 HELLO/READONLY) finish re-arming -- see issue #527\n"
